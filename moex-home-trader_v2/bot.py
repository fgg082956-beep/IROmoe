# [FIX] expired callback handling — если callback_data не найдена в кэше идей,
# рекомендуется ответить answerCallbackQuery с text="Идея устарела"
# (см. pattern ниже, искать "callback_query").
# ============================================================
